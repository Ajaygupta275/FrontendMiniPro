let generatePalette=()=>{
    ...
    const palette=generateHarmoinousPalette(baseColor);
...
function generateHarmoinousPalette(baseColor){
    const numberOfColors=5;
    const baseHue=extraHue(baseColor);
    const colorPalette=[];
